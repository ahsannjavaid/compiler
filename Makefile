...
LEX_C = lex.yy.c
PARSER_C = arrays.tab.c
PARSER_H = arrays.tab.h
...
# Compile the arrays compiler
$(EXECUTABLE): $(LEX_C) $(PARSER_C)
	$(CXX) -o $(EXECUTABLE) $(PARSER_C) $(LEX_C)

# Run the arrays compiler with the sample input file
run: $(EXECUTABLE)
...
distclean: clean
	rm -f a.out arrays.output

# Show available Makefile commands
help:
	@echo "Available targets:"
	@echo "  make        - Compile the arrays compiler"
	@echo "  make run    - Run the arrays compiler with the test file"
